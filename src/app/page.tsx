    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="container mx-auto px-4 py-8 md:py-12">
        <nav className="flex items-center justify-between mb-12">
          <h1 className="text-2xl font-bold text-red-500">MobileFix</h1>
          <button className="text-red-500 border-red-500 px-4 py-2 border rounded-md">
            Contacto
          </button>
        </nav>
        ...
        <div>
              <img 
                ...
                alt="Reparación" 
                className="rounded-3xl object-cover h-full w-full opacity-70"
              />
            </div>
      ...
      <section className="container mx-auto px-4 py-12">
        <h3 className="text-3xl font-bold text-center mb-8 italic">Nuestros Servicios</h3>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <h3 className="text-6xl font-bold text-center mb-20">¿Por qué elegirnos?</h3>
