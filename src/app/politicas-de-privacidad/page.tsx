  ...
  const sections = [
    {
      ...
      content: "En TechFix, recopilamos la siguiente información cuando utiliza nuestros servicios:",
      list: [
    ...
    },
    {
      ...
      content: "No compartimos su información personal con terceros, excepto cuando sea necesario para completar su servicio de reparación o cuando sea requerido por ley."
    },
    {
      title: "5. Sus Derechos",
      content: "Usted tiene derecho a acceder, corregir o solicitar la eliminación de su información personal. Puede ejercer estos derechos contactándonos directamente."
    }
  ];
